...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    public partial class SymbolRecognitionResult :  IEquatable<SymbolRecognitionResult>, IValidatableObject
    {
        ...
        public SymbolRecognitionResult(RectangleCoordinates symbolRect = default(RectangleCoordinates), decimal candidatesCount = default(decimal), List<SymbolCandidate> listOfCandidates = default(List<SymbolCandidate>), Object reserved = default(Object))
        {
            ...
            // to ensure "candidatesCount" is required (not null)
            if (candidatesCount == null)
            {
                throw new InvalidDataException("candidatesCount is a required property for SymbolRecognitionResult and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="CandidatesCount", EmitDefaultValue=true)]
