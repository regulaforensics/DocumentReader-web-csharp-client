...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GraphicsResult :  IEquatable<GraphicsResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GraphicsResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GraphicsResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GraphicsResult" /> class.
        /// </summary>
        ...
        public GraphicsResult(GraphicFieldsList docGraphicsInfo = default(GraphicFieldsList), int bufLength = default(int), int light = default(int), int listIdx = default(int), int pageIdx = default(int), int resultType = 0)
        {
            // to ensure "docGraphicsInfo" is required (not null)
            if (docGraphicsInfo == null)
            {
                throw new InvalidDataException("docGraphicsInfo is a required property for GraphicsResult and cannot be null");
            }
            else
            {
            ...
            if (resultType == null)
            {
                throw new InvalidDataException("resultType is a required property for GraphicsResult and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        [DataMember(Name="DocGraphicsInfo", EmitDefaultValue=true)]
        ...
        {
            return this.Equals(input as GraphicsResult);
        }

        /// <summary>
        /// Returns true if GraphicsResult instances are equal
        /// </summary>
        /// <param name="input">Instance of GraphicsResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GraphicsResult input)
        {
            if (input == null)
                return false;
