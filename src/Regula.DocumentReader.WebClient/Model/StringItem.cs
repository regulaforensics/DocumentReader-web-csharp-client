...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    public partial class StringItem : IValidatableObject
    {
        ...
        public StringItem(CheckResult aLIGNMENTSYMBOLSINSTRING = default, CheckResult cHECKSUMS = default, ErrorCoordinates errorPOSITION = default, int fieldCount = default, List<FieldItem> fields = default, CheckResult sTRINGSDISTANCE = default, CheckResult sTRINGSINTERVAL = default, CheckResult sTRINGFILLING = default, CheckResult? sTRINGSPOSITION = default, CheckResult sYMBOLSPARAM = default, decimal sizeErrorALIGNMENT = default, decimal sizeErrorDISTANCE = default, decimal sizeErrorINTERVAL = default, decimal stringAngle = default, RectangleCoordinates stringBorders = default, int symbolsCount = default, List<SymbolEstimationItem> symbolsEstimations = default)
        {
