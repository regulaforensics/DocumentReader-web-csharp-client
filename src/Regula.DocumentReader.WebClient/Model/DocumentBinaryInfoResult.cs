...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DocumentBinaryInfoResult :  IEquatable<DocumentBinaryInfoResult>, IValidatableObject
    {
        /// <summary>
        ...
        public DocumentBinaryInfoResult(TDocBinaryInfo tDocBinaryInfo = default(TDocBinaryInfo), int bufLength = default(int), int light = default(int), int listIdx = default(int), int pageIdx = default(int), int resultType = 0)
        {
            ...
            if (resultType == null)
            {
                throw new InvalidDataException("resultType is a required property for DocumentBinaryInfoResult and cannot be null");
            }
            else
            {
