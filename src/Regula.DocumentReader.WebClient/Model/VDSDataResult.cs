...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    public partial class VDSDataResult : ResultItem, IValidatableObject
    {
        ...
        public VDSDataResult(VDSData dftVDS = default, int? bufLength = default, int? light = default, int? listIdx = default, int? pageIdx = default, Result resultType = Result.VDS) : base(bufLength, light, listIdx, pageIdx, resultType)
        {
