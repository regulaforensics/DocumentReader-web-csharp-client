...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TransactionProcessResponse :  IEquatable<TransactionProcessResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionProcessResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransactionProcessResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionProcessResponse" /> class.
        /// </summary>
        /// <param name="coreLibResultCode">coreLibResultCode (required).</param>
        ...
        public TransactionProcessResponse(int coreLibResultCode = default(int), Integer chipPage = default(Integer), Integer processingFinished = default(Integer), ContainerList containerList = default(ContainerList), TransactionInfo transactionInfo = default(TransactionInfo), string log = default(string), Dictionary<string, Object> passBackObject = default(Dictionary<string, Object>), int morePagesAvailable = default(int), int elapsedTime = default(int), Dictionary<string, Object> metadata = default(Dictionary<string, Object>))
        {
            // to ensure "coreLibResultCode" is required (not null)
            if (coreLibResultCode == null)
            {
                throw new InvalidDataException("coreLibResultCode is a required property for TransactionProcessResponse and cannot be null");
            }
            else
            {
            ...
            if (chipPage == null)
            {
                throw new InvalidDataException("chipPage is a required property for TransactionProcessResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("processingFinished is a required property for TransactionProcessResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("containerList is a required property for TransactionProcessResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("transactionInfo is a required property for TransactionProcessResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("morePagesAvailable is a required property for TransactionProcessResponse and cannot be null");
            }
            else
            {
            ...
            if (elapsedTime == null)
            {
                throw new InvalidDataException("elapsedTime is a required property for TransactionProcessResponse and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        [DataMember(Name="CoreLibResultCode", EmitDefaultValue=true)]
        ...
        {
            return this.Equals(input as TransactionProcessResponse);
        }

        /// <summary>
        /// Returns true if TransactionProcessResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionProcessResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionProcessResponse input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.CoreLibResultCode == input.CoreLibResultCode ||
                    (this.CoreLibResultCode != null &&
                    this.CoreLibResultCode.Equals(input.CoreLibResultCode))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.CoreLibResultCode != null)
                    hashCode = hashCode * 59 + this.CoreLibResultCode.GetHashCode();
