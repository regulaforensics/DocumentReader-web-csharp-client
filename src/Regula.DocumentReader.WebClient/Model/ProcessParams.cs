...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    public partial class ProcessParams :  IEquatable<ProcessParams>, IValidatableObject
    {
        ...
        /// <param name="splitNames">If it is set to true, the Surname and GivenNames fields from the MRZ will be divided into the ft_First_Name, ft_Second_Name, ft_Third_Name, ft_Fourth_Name, ft_Last_Name fields.</param>
        /// <param name="disablePerforationOCR">Disables reading perforated fields.</param>
        /// <param name="processAuth">Checks filter.</param>
        /// <param name="documentGroupFilter">Filter documents by group.</param>
        /// <param name="respectImageQuality">When it true ImageQuality can affect on Optical Status.</param>
        public ProcessParams(string scenario = default(string), List<int> resultTypeOutput = default(List<int>), bool doublePageSpread = default(bool), bool generateDoublePageSpreadImage = default(bool), List<int> fieldTypesFilter = default(List<int>), string dateFormat = default(string), int measureSystem = default(int), int imageDpiOutMax = default(int), bool alreadyCropped = default(bool), Dictionary<string, Object> customParams = default(Dictionary<string, Object>), List<PerDocumentConfig> config = default(List<PerDocumentConfig>), bool log = default(bool), string logLevel = default(string), int forceDocID = default(int), bool matchTextFieldMask = default(bool), bool fastDocDetect = default(bool), bool updateOCRValidityByGlare = default(bool), bool checkRequiredTextFields = default(bool), bool returnCroppedBarcode = default(bool), ImageQA imageQa = default(ImageQA), int forceDocFormat = default(int), bool noGraphics = default(bool), float documentAreaMin = default(float), bool depersonalizeLog = default(bool), bool multiDocOnImage = default(bool), int shiftExpiryDate = default(int), int minimalHolderAge = default(int), bool returnUncroppedImage = default(bool), List<string> mrzFormatsFilter = default(List<string>), bool forceReadMrzBeforeLocate = default(bool), bool parseBarcodes = default(bool), int convertCase = default(int), bool splitNames = default(bool), bool disablePerforationOCR = default(bool), bool processAuth = default(bool), string documentGroupFilter = default(string), bool respectImageQuality = default(bool))
        {
        ...
        /// </summary>
        /// <value>If it is set to true, the Surname and GivenNames fields from the MRZ will be divided into the ft_First_Name, ft_Second_Name, ft_Third_Name, ft_Fourth_Name, ft_Last_Name fields</value>
        ...
        /// </summary>
        /// <value>Disables reading perforated fields</value>
        ...
        /// Checks filter
        /// </summary>
        /// <value>Checks filter</value>
        [DataMember(Name="processAuth", EmitDefaultValue=false)]
        public bool ProcessAuth { get; set; }

        /// <summary>
        /// Filter documents by group
        /// </summary>
        /// <value>Filter documents by group</value>
        [DataMember(Name="documentGroupFilter", EmitDefaultValue=false)]
        public string DocumentGroupFilter { get; set; }

        /// <summary>
        /// When it true ImageQuality can affect on Optical Status
        /// </summary>
        /// <value>When it true ImageQuality can affect on Optical Status</value>
        ...
        public bool Equals(ProcessParams input)
        {
            ...
            return 
                ...
                (
                    ...
                    this.DocumentGroupFilter.Equals(input.DocumentGroupFilter))
                ) && 
                (
