...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ImageQualityResult :  IEquatable<ImageQualityResult>, IValidatableObject
    {
        /// <summary>
        ...
        public ImageQualityResult(ImageQualityCheckList imageQualityCheckList = default(ImageQualityCheckList), int bufLength = default(int), int light = default(int), int listIdx = default(int), int pageIdx = default(int), int resultType = 0)
        {
            ...
            if (resultType == null)
            {
                throw new InvalidDataException("resultType is a required property for ImageQualityResult and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        [DataMember(Name="ImageQualityCheckList", EmitDefaultValue=true)]
