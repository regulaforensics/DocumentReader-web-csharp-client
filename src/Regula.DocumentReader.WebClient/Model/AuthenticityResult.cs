...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AuthenticityResult :  IEquatable<AuthenticityResult>, IValidatableObject
    {
        /// <summary>
        ...
        public AuthenticityResult(AuthenticityCheckList authenticityCheckList = default(AuthenticityCheckList), int bufLength = default(int), int light = default(int), int listIdx = default(int), int pageIdx = default(int), int resultType = 0)
        {
            ...
            if (resultType == null)
            {
                throw new InvalidDataException("resultType is a required property for AuthenticityResult and cannot be null");
            }
            else
            {
