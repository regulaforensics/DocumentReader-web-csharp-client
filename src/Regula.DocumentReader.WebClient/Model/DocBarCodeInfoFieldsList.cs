...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    public partial class DocBarCodeInfoFieldsList :  IEquatable<DocBarCodeInfoFieldsList>, IValidatableObject
    {
        ...
        public DocBarCodeInfoFieldsList(int nFields = default(int), List<PArrayField> pArrayFields = default(List<PArrayField>))
        {
            ...
            if (nFields == null)
            {
                throw new InvalidDataException("nFields is a required property for DocBarCodeInfoFieldsList and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("pArrayFields is a required property for DocBarCodeInfoFieldsList and cannot be null");
            }
            else
            {
