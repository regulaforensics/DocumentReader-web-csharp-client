...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TextResult :  IEquatable<TextResult>, IValidatableObject
    {
        /// <summary>
        ...
        public TextResult(Text text = default(Text), int bufLength = default(int), int light = default(int), int listIdx = default(int), int pageIdx = default(int), int resultType = 0)
        {
            // to ensure "text" is required (not null)
            if (text == null)
            {
                throw new InvalidDataException("text is a required property for TextResult and cannot be null");
            }
            else
            {
                this.Text = text;
            ...
            if (resultType == null)
            {
                throw new InvalidDataException("resultType is a required property for TextResult and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TextResult);
        }

        /// <summary>
        /// Returns true if TextResult instances are equal
        /// </summary>
        /// <param name="input">Instance of TextResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TextResult input)
        {
            if (input == null)
                return false;
