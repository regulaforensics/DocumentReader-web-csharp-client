...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    public partial class IdentResult : AuthenticityCheckResultItem,  IEquatable<IdentResult>, IValidatableObject
    {
        ...
        public IdentResult(SecurityFeatureType? elementType = default(SecurityFeatureType?), int lightIndex = default(int), RectangleCoordinates area = default(RectangleCoordinates), ImageData image = default(ImageData), ImageData etalonImage = default(ImageData), int percentValue = default(int), List<AreaContainer> areaList = default(List<AreaContainer>), int type = "IdentResult", int elementResult = default(int), CheckDiagnose? elementDiagnose = default(CheckDiagnose?)) : base(type, elementResult, elementDiagnose)
        {
