...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    /// IdentResult
    /// </summary>
    public partial class IdentResult : AuthenticityCheckResultItem, IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public IdentResult(SecurityFeatureType elementType, Light lightIndex, ImageData image, ImageData etalonImage, Option<CheckResult?> elementResult = default, Option<CheckDiagnose?> elementDiagnose = default, Option<int?> percentValue = default, Option<RectangleCoordinates?> area = default, Option<AreaContainer?> areaList = default) : base(elementResult, elementDiagnose, percentValue)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="IdentResult" />
    /// </summary>
    public class IdentResultJsonConverter : JsonConverter<IdentResult>
    {
        /// <summary>
        /// Deserializes json to <see cref="IdentResult" />
        /// </summary>
        ...
        public override IdentResult Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!elementType.IsSet)
                throw new ArgumentException("Property is required for class IdentResult.", nameof(elementType));

            if (!lightIndex.IsSet)
                throw new ArgumentException("Property is required for class IdentResult.", nameof(lightIndex));

            if (!image.IsSet)
                throw new ArgumentException("Property is required for class IdentResult.", nameof(image));

            if (!etalonImage.IsSet)
                throw new ArgumentException("Property is required for class IdentResult.", nameof(etalonImage));

            if (!type.IsSet)
                throw new ArgumentException("Property is required for class IdentResult.", nameof(type));

            if (elementType.IsSet && elementType.Value == null)
                throw new ArgumentNullException(nameof(elementType), "Property is not nullable for class IdentResult.");

            if (lightIndex.IsSet && lightIndex.Value == null)
                throw new ArgumentNullException(nameof(lightIndex), "Property is not nullable for class IdentResult.");

            if (image.IsSet && image.Value == null)
                throw new ArgumentNullException(nameof(image), "Property is not nullable for class IdentResult.");

            if (etalonImage.IsSet && etalonImage.Value == null)
                throw new ArgumentNullException(nameof(etalonImage), "Property is not nullable for class IdentResult.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class IdentResult.");

            if (elementResult.IsSet && elementResult.Value == null)
                throw new ArgumentNullException(nameof(elementResult), "Property is not nullable for class IdentResult.");

            if (elementDiagnose.IsSet && elementDiagnose.Value == null)
                throw new ArgumentNullException(nameof(elementDiagnose), "Property is not nullable for class IdentResult.");

            if (percentValue.IsSet && percentValue.Value == null)
                throw new ArgumentNullException(nameof(percentValue), "Property is not nullable for class IdentResult.");

            if (area.IsSet && area.Value == null)
                throw new ArgumentNullException(nameof(area), "Property is not nullable for class IdentResult.");

            if (areaList.IsSet && areaList.Value == null)
                throw new ArgumentNullException(nameof(areaList), "Property is not nullable for class IdentResult.");

            return new IdentResult(elementType.Value!.Value!, lightIndex.Value!.Value!, image.Value!, etalonImage.Value!, elementResult, elementDiagnose, percentValue, area, areaList);
        }

        /// <summary>
        /// Serializes a <see cref="IdentResult" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="identResult"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, IdentResult identResult, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes the properties of <see cref="IdentResult" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="identResult"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, IdentResult identResult, JsonSerializerOptions jsonSerializerOptions)
        {
            if (identResult.Image == null)
                throw new ArgumentNullException(nameof(identResult.Image), "Property is required for class IdentResult.");

            if (identResult.EtalonImage == null)
                throw new ArgumentNullException(nameof(identResult.EtalonImage), "Property is required for class IdentResult.");

            if (identResult.AreaOption.IsSet && identResult.Area == null)
                throw new ArgumentNullException(nameof(identResult.Area), "Property is required for class IdentResult.");

            if (identResult.AreaListOption.IsSet && identResult.AreaList == null)
                throw new ArgumentNullException(nameof(identResult.AreaList), "Property is required for class IdentResult.");

            var elementTypeRawValue = SecurityFeatureTypeValueConverter.ToJsonValue(identResult.ElementType);
            writer.WriteNumber("ElementType", elementTypeRawValue);

            var lightIndexRawValue = LightValueConverter.ToJsonValue(identResult.LightIndex);
            ...
            {
                var elementResultRawValue = CheckResultValueConverter.ToJsonValue(identResult.ElementResult!.Value);
                writer.WriteNumber("ElementResult", elementResultRawValue);
            }
            if (identResult.ElementDiagnoseOption.IsSet)
            {
                var elementDiagnoseRawValue = CheckDiagnoseValueConverter.ToJsonValue(identResult.ElementDiagnose!.Value);
                writer.WriteNumber("ElementDiagnose", elementDiagnoseRawValue);
            }
            if (identResult.PercentValueOption.IsSet)
                writer.WriteNumber("PercentValue", identResult.PercentValueOption.Value!.Value);

            if (identResult.AreaOption.IsSet)
            {
                writer.WritePropertyName("Area");
                JsonSerializer.Serialize(writer, identResult.Area, jsonSerializerOptions);
            }
            if (identResult.AreaListOption.IsSet)
            {
                writer.WritePropertyName("AreaList");
                JsonSerializer.Serialize(writer, identResult.AreaList, jsonSerializerOptions);
            }
        }
    }
}
