...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    /// FiberItem
    /// </summary>
    public partial class FiberItem : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FiberItem" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public FiberItem(int rectCount, int expectedCount, List<RectangleCoordinates> rectArray, List<int> width, List<int> length, List<int> area, List<int> colorValues, Option<Light?> lightValue = default, Option<int?> lightDisp = default)
        {
            RectCount = rectCount;
    ...
    /// <summary>
    /// A Json converter for type <see cref="FiberItem" />
    /// </summary>
    public class FiberItemJsonConverter : JsonConverter<FiberItem>
    {
        /// <summary>
        /// Deserializes json to <see cref="FiberItem" />
        /// </summary>
        ...
        public override FiberItem Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!rectCount.IsSet)
                throw new ArgumentException("Property is required for class FiberItem.", nameof(rectCount));

            if (!expectedCount.IsSet)
                throw new ArgumentException("Property is required for class FiberItem.", nameof(expectedCount));

            if (!rectArray.IsSet)
                throw new ArgumentException("Property is required for class FiberItem.", nameof(rectArray));

            if (!width.IsSet)
                throw new ArgumentException("Property is required for class FiberItem.", nameof(width));

            if (!length.IsSet)
                throw new ArgumentException("Property is required for class FiberItem.", nameof(length));

            if (!area.IsSet)
                throw new ArgumentException("Property is required for class FiberItem.", nameof(area));

            if (!colorValues.IsSet)
                throw new ArgumentException("Property is required for class FiberItem.", nameof(colorValues));

            if (rectCount.IsSet && rectCount.Value == null)
                throw new ArgumentNullException(nameof(rectCount), "Property is not nullable for class FiberItem.");

            if (expectedCount.IsSet && expectedCount.Value == null)
                throw new ArgumentNullException(nameof(expectedCount), "Property is not nullable for class FiberItem.");

            if (rectArray.IsSet && rectArray.Value == null)
                throw new ArgumentNullException(nameof(rectArray), "Property is not nullable for class FiberItem.");

            if (width.IsSet && width.Value == null)
                throw new ArgumentNullException(nameof(width), "Property is not nullable for class FiberItem.");

            if (length.IsSet && length.Value == null)
                throw new ArgumentNullException(nameof(length), "Property is not nullable for class FiberItem.");

            if (area.IsSet && area.Value == null)
                throw new ArgumentNullException(nameof(area), "Property is not nullable for class FiberItem.");

            if (colorValues.IsSet && colorValues.Value == null)
                throw new ArgumentNullException(nameof(colorValues), "Property is not nullable for class FiberItem.");

            if (lightValue.IsSet && lightValue.Value == null)
                throw new ArgumentNullException(nameof(lightValue), "Property is not nullable for class FiberItem.");

            if (lightDisp.IsSet && lightDisp.Value == null)
                throw new ArgumentNullException(nameof(lightDisp), "Property is not nullable for class FiberItem.");

            return new FiberItem(rectCount.Value!.Value!, expectedCount.Value!.Value!, rectArray.Value!, width.Value!, length.Value!, area.Value!, colorValues.Value!, lightValue, lightDisp);
        }

        /// <summary>
        /// Serializes a <see cref="FiberItem" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="fiberItem"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, FiberItem fiberItem, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, fiberItem, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="FiberItem" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="fiberItem"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, FiberItem fiberItem, JsonSerializerOptions jsonSerializerOptions)
        {
            if (fiberItem.RectArray == null)
                throw new ArgumentNullException(nameof(fiberItem.RectArray), "Property is required for class FiberItem.");

            if (fiberItem.Width == null)
                throw new ArgumentNullException(nameof(fiberItem.Width), "Property is required for class FiberItem.");

            if (fiberItem.Length == null)
                throw new ArgumentNullException(nameof(fiberItem.Length), "Property is required for class FiberItem.");

            if (fiberItem.Area == null)
                throw new ArgumentNullException(nameof(fiberItem.Area), "Property is required for class FiberItem.");

            if (fiberItem.ColorValues == null)
                throw new ArgumentNullException(nameof(fiberItem.ColorValues), "Property is required for class FiberItem.");

            writer.WriteNumber("RectCount", fiberItem.RectCount);

            writer.WriteNumber("ExpectedCount", fiberItem.ExpectedCount);

            writer.WritePropertyName("RectArray");
            JsonSerializer.Serialize(writer, fiberItem.RectArray, jsonSerializerOptions);
            writer.WritePropertyName("Width");
            JsonSerializer.Serialize(writer, fiberItem.Width, jsonSerializerOptions);
            writer.WritePropertyName("Length");
            JsonSerializer.Serialize(writer, fiberItem.Length, jsonSerializerOptions);
            writer.WritePropertyName("Area");
            JsonSerializer.Serialize(writer, fiberItem.Area, jsonSerializerOptions);
            writer.WritePropertyName("ColorValues");
            JsonSerializer.Serialize(writer, fiberItem.ColorValues, jsonSerializerOptions);
            if (fiberItem.LightValueOption.IsSet)
            {
                var lightValueRawValue = LightValueConverter.ToJsonValue(fiberItem.LightValue!.Value);
                writer.WriteNumber("LightValue", lightValueRawValue);
            }
            if (fiberItem.LightDispOption.IsSet)
                writer.WriteNumber("LightDisp", fiberItem.LightDispOption.Value!.Value);
        }
    }
}
