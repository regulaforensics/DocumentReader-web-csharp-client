...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    public partial class FiberItem : IValidatableObject
    {
        ...
        public FiberItem(int rectCount = default, int expectedCount = default, Light? lightValue = default, int? lightDisp = default, List<RectangleCoordinates> rectArray = default, List<int> width = default, List<int> length = default, List<int> area = default, List<int> colorValues = default)
        {
            ...
            if (rectArray == null)
            {
                throw new ArgumentNullException("rectArray is a required property for FiberItem and cannot be null");
            }
            this.RectArray = rectArray;
            // to ensure "width" is required (not null)
            if (width == null)
            {
                throw new ArgumentNullException("width is a required property for FiberItem and cannot be null");
            }
            this.Width = width;
            // to ensure "length" is required (not null)
            if (length == null)
            {
                throw new ArgumentNullException("length is a required property for FiberItem and cannot be null");
            }
            this.Length = length;
            // to ensure "area" is required (not null)
            if (area == null)
            {
                throw new ArgumentNullException("area is a required property for FiberItem and cannot be null");
            }
            this.Area = area;
            // to ensure "colorValues" is required (not null)
            if (colorValues == null)
            {
                throw new ArgumentNullException("colorValues is a required property for FiberItem and cannot be null");
            }
