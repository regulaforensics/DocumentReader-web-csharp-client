...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    public partial class OriginalSymbol :  IEquatable<OriginalSymbol>, IValidatableObject
    {
        ...
        public OriginalSymbol(long code = default(long), int probability = default(int), RectangleCoordinates rect = default(RectangleCoordinates))
        {
            ...
            if (code == null)
            {
                throw new InvalidDataException("code is a required property for OriginalSymbol and cannot be null");
            }
            else
            {
                this.Code = code;
            ...
            if (probability == null)
            {
                throw new InvalidDataException("probability is a required property for OriginalSymbol and cannot be null");
            }
            else
            {
