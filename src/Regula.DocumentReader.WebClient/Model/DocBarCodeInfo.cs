...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DocBarCodeInfo :  IEquatable<DocBarCodeInfo>, IValidatableObject
    {
        /// <summary>
        ...
        public DocBarCodeInfo(DocBarCodeInfoFieldsList docBarCodeInfo = default(DocBarCodeInfoFieldsList), int bufLength = default(int), int light = default(int), int listIdx = default(int), int pageIdx = default(int), int resultType = 0)
        {
            // to ensure "docBarCodeInfo" is required (not null)
            if (docBarCodeInfo == null)
            {
                throw new InvalidDataException("docBarCodeInfo is a required property for DocBarCodeInfo and cannot be null");
            }
            else
            {
            ...
            if (resultType == null)
            {
                throw new InvalidDataException("resultType is a required property for DocBarCodeInfo and cannot be null");
            }
            else
            {
