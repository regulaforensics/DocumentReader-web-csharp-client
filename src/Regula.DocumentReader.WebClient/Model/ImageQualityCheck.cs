...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    public partial class ImageQualityCheck :  IEquatable<ImageQualityCheck>, IValidatableObject
    {
        ...
        public ImageQualityCheck(ImageQualityCheckType? type = default(ImageQualityCheckType?), int result = default(int), int featureType = default(int), List<AreaArray> areas = default(List<AreaArray>), Numbers mean = default(Numbers), Numbers stdDev = default(Numbers), int probability = default(int))
        {
            this.Type = type;
            this.Result = result;
        ...
        public List<AreaArray> Areas { get; set; }

        /// <summary>
        /// Gets or Sets Mean
        /// </summary>
        [DataMember(Name="mean", EmitDefaultValue=false)]
        public Numbers Mean { get; set; }

        /// <summary>
        /// Gets or Sets StdDev
        /// </summary>
        [DataMember(Name="stdDev", EmitDefaultValue=false)]
        public Numbers StdDev { get; set; }
