...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    public partial class Symbol : IValidatableObject
    {
        ...
        public Symbol(List<int> boundingRect = default(List<int>))
        {
            ...
            {
                throw new ArgumentNullException("boundingRect is a required property for Symbol and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "boundingRect", IsRequired = true, EmitDefaultValue = true)]
