...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    public partial class FDSIDList :  IEquatable<FDSIDList>, IValidatableObject
    {
        ...
        public FDSIDList(string iCAOCode = default(string), decimal count = default(decimal), List<int> list = default(List<int>), Integer dType = default(Integer), Integer dFormat = default(Integer), bool dMRZ = default(bool), string dDescription = default(string), string dYear = default(string), string dCountryName = default(string), string dStateCode = default(string), string dStateName = default(string), bool isDeprecated = default(bool))
        {
            ...
            if (iCAOCode == null)
            {
                throw new InvalidDataException("iCAOCode is a required property for FDSIDList and cannot be null");
            }
            else
            {
            ...
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for FDSIDList and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            if (list == null)
            {
                throw new InvalidDataException("list is a required property for FDSIDList and cannot be null");
            }
            else
            {
                this.List = list;
            ...
            if (dType == null)
            {
                throw new InvalidDataException("dType is a required property for FDSIDList and cannot be null");
            }
            else
            {
                this.DType = dType;
            ...
            // to ensure "dFormat" is required (not null)
            if (dFormat == null)
            {
                throw new InvalidDataException("dFormat is a required property for FDSIDList and cannot be null");
            }
            else
            {
            ...
            // to ensure "dMRZ" is required (not null)
            if (dMRZ == null)
            {
                throw new InvalidDataException("dMRZ is a required property for FDSIDList and cannot be null");
            }
            else
            {
                this.DMRZ = dMRZ;
            ...
            if (dYear == null)
            {
                throw new InvalidDataException("dYear is a required property for FDSIDList and cannot be null");
            }
            else
            {
                this.DYear = dYear;
            ...
            {
                throw new InvalidDataException("dCountryName is a required property for FDSIDList and cannot be null");
            }
            else
            {
            ...
            // to ensure "isDeprecated" is required (not null)
            if (isDeprecated == null)
            {
                throw new InvalidDataException("isDeprecated is a required property for FDSIDList and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="ICAOCode", EmitDefaultValue=true)]
        ...
        [DataMember(Name="dMRZ", EmitDefaultValue=true)]
        ...
        [DataMember(Name="dYear", EmitDefaultValue=true)]
        ...
        [DataMember(Name="dCountryName", EmitDefaultValue=true)]
