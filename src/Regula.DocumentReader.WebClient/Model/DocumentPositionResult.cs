...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DocumentPositionResult :  IEquatable<DocumentPositionResult>, IValidatableObject
    {
        /// <summary>
        ...
        public DocumentPositionResult(DocumentPosition documentPosition = default(DocumentPosition), int bufLength = default(int), int light = default(int), int listIdx = default(int), int pageIdx = default(int), int resultType = 0)
        {
            // to ensure "documentPosition" is required (not null)
            if (documentPosition == null)
            {
                throw new InvalidDataException("documentPosition is a required property for DocumentPositionResult and cannot be null");
            }
            else
            {
            ...
            if (resultType == null)
            {
                throw new InvalidDataException("resultType is a required property for DocumentPositionResult and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        [DataMember(Name="DocumentPosition", EmitDefaultValue=true)]
