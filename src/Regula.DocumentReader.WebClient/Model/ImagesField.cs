...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    public partial class ImagesField :  IEquatable<ImagesField>, IValidatableObject
    {
        ...
        public ImagesField(string fieldName = default(string), int fieldType = default(int), List<ImagesFieldValue> valueList = default(List<ImagesFieldValue>), decimal valueCount = default(decimal))
        {
            ...
            // to ensure "valueCount" is required (not null)
            if (valueCount == null)
            {
                throw new InvalidDataException("valueCount is a required property for ImagesField and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="valueCount", EmitDefaultValue=true)]
