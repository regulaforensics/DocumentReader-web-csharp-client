...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    public partial class AuthenticityCheckResultItem :  IEquatable<AuthenticityCheckResultItem>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="AuthenticityCheckResultItem" /> class.
        /// </summary>
        /// <param name="type">Same as authenticity result type, but used for safe parsing of not-described values. See authenticity result type (required).</param>
        /// <param name="elementResult">elementResult.</param>
        /// <param name="elementDiagnose">elementDiagnose.</param>
        public AuthenticityCheckResultItem(int type = default(int), int elementResult = default(int), CheckDiagnose? elementDiagnose = default(CheckDiagnose?))
        {
