...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    public partial class TextField :  IEquatable<TextField>, IValidatableObject
    {
        ...
        /// <param name="lcidName">LCID name (required).</param>
        ...
        public TextField(int fieldType = default(int), string fieldName = default(string), int lcid = default(int), string lcidName = default(string), int status = default(int), int validityStatus = default(int), int comparisonStatus = default(int), string value = default(string), List<TextFieldValue> valueList = default(List<TextFieldValue>), List<SourceValidity> validityList = default(List<SourceValidity>), List<CrossSourceValueComparison> comparisonList = default(List<CrossSourceValueComparison>))
        {
            ...
            // to ensure "lcid" is required (not null)
            if (lcid == null)
            {
                throw new InvalidDataException("lcid is a required property for TextField and cannot be null");
            }
            else
            {
                this.Lcid = lcid;
            ...
            // to ensure "lcidName" is required (not null)
            if (lcidName == null)
            {
                throw new InvalidDataException("lcidName is a required property for TextField and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="lcidName", EmitDefaultValue=true)]
        ...
        public bool Equals(TextField input)
        {
            ...
            return 
                ...
                (
                    this.LcidName == input.LcidName ||
                    (this.LcidName != null &&
                    this.LcidName.Equals(input.LcidName))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.LcidName != null)
                    hashCode = hashCode * 59 + this.LcidName.GetHashCode();
                if (this.Status != null)
