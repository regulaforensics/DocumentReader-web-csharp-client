...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    public partial class ChosenDocumentType :  IEquatable<ChosenDocumentType>, IValidatableObject
    {
        ...
        public ChosenDocumentType(string documentName = default(string), int iD = default(int), decimal p = default(decimal), bool rotated180 = default(bool), Integer rFIDPresence = default(Integer), FDSIDList fDSIDList = default(FDSIDList), int necessaryLights = default(int), int checkAuthenticity = default(int), int uVExp = default(int), int authenticityNecessaryLights = default(int), decimal oVIExp = default(decimal))
        {
