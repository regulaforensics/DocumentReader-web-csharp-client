...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EncryptedRCLResult :  IEquatable<EncryptedRCLResult>, IValidatableObject
    {
        /// <summary>
        ...
        public EncryptedRCLResult(byte[] encryptedRCL = default(byte[]), int bufLength = default(int), int light = default(int), int listIdx = default(int), int pageIdx = default(int), int resultType = 0)
        {
            ...
            if (resultType == null)
            {
                throw new InvalidDataException("resultType is a required property for EncryptedRCLResult and cannot be null");
            }
            else
            {
