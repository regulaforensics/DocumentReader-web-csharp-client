...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    public partial class RfidSessionData : IValidatableObject
    {
        ...
        public RfidSessionData(bool? virtualMode = default, string? sDKVersion = default, string? driverVersion = default, string? firmwareVersion = default, List<RfidApplication> applications = default, List<RfidAccessControlInfo> accessControls = default, RfidCardPropertiesExt cardProperties = default, RFIDErrorCodes extLeSupport = default, decimal processTime = default, List<Object> rootFiles = default, decimal totalBytesSent = default, decimal totalBytesReceived = default, RfidAccessKey? sessionKey = default, RfidTerminal sessionTerminal = default, RfidAuthenticationProcedureType sessionProcedure = default, List<RfidSecurityObject> securityObjects = default, CheckResult? status = default)
        {
