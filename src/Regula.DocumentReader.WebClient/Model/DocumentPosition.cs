...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    /// DocumentPosition
    /// </summary>
    [DataContract(Name = "DocumentPosition")]
    public partial class DocumentPosition : IValidatableObject
    {
        ...
        public DocumentPosition(DocumentFormat docFormat = default(DocumentFormat), decimal angle = default(decimal), int width = default(int), int height = default(int), Point center = default(Point), Point leftBottom = default(Point), Point leftTop = default(Point), Point rightBottom = default(Point), Point rightTop = default(Point), int dpi = default(int), int inverse = default(int), int objArea = default(int), int objIntAngleDev = default(int), int perspectiveTr = default(int), int resultStatus = default(int))
        {
            ...
            if (center == null)
            {
                throw new ArgumentNullException("center is a required property for DocumentPosition and cannot be null");
            }
            this.Center = center;
            // to ensure "leftBottom" is required (not null)
            if (leftBottom == null)
            {
                throw new ArgumentNullException("leftBottom is a required property for DocumentPosition and cannot be null");
            }
            this.LeftBottom = leftBottom;
            // to ensure "leftTop" is required (not null)
            if (leftTop == null)
            {
                throw new ArgumentNullException("leftTop is a required property for DocumentPosition and cannot be null");
            }
            this.LeftTop = leftTop;
            // to ensure "rightBottom" is required (not null)
            if (rightBottom == null)
            {
                throw new ArgumentNullException("rightBottom is a required property for DocumentPosition and cannot be null");
            }
            this.RightBottom = rightBottom;
            // to ensure "rightTop" is required (not null)
            if (rightTop == null)
            {
                throw new ArgumentNullException("rightTop is a required property for DocumentPosition and cannot be null");
            }
