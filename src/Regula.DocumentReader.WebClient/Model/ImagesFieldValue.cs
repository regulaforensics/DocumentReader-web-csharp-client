...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    public partial class ImagesFieldValue :  IEquatable<ImagesFieldValue>, IValidatableObject
    {
        ...
        public ImagesFieldValue(String source = default(String), string value = default(string), string originalValue = default(string), int originalPageIndex = default(int), int pageIndex = default(int), Integer lightIndex = default(Integer), int containerType = 0, RectangleCoordinates fieldRect = default(RectangleCoordinates), RfidOrigin rfidOrigin = default(RfidOrigin))
        {
        ...
        public bool Equals(ImagesFieldValue input)
        {
            ...
            return 
                ...
                (
                    this.OriginalPageIndex == input.OriginalPageIndex ||
                    (this.OriginalPageIndex != null &&
                    this.OriginalPageIndex.Equals(input.OriginalPageIndex))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.OriginalPageIndex != null)
                    hashCode = hashCode * 59 + this.OriginalPageIndex.GetHashCode();
