...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    /// FaceDetectionResult
    /// </summary>
    [DataContract(Name = "FaceDetectionResult")]
    public partial class FaceDetectionResult : ResultItem, IValidatableObject
    {
        ...
        public FaceDetectionResult(FaceDetection faceDetection = default(FaceDetection), int bufLength = default(int), int light = default(int), int listIdx = default(int), int pageIdx = default(int), int resultType = 0) : base(bufLength, light, listIdx, pageIdx, resultType)
        {
