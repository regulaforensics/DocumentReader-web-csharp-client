...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    public partial class DeviceInfo :  IEquatable<DeviceInfo>, IValidatableObject
    {
        ...
        public DeviceInfo(string app = default(string), string licenseId = default(string), string licenseType = default(string), string licenseSerial = default(string), DateTime licenseValidUntil = default(DateTime), List<string> scenarios = default(List<string>), string version = default(string))
        {
            this.App = app;
