...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    public partial class VerifiedFieldMap : IValidatableObject
    {
        ...
        public VerifiedFieldMap(TextFieldType wFieldType = default, LCID wLCID = default, string? fieldMRZ = default, string? fieldVisual = default, string? fieldBarcode = default, string? fieldRFID = default, List<VerificationResult> matrix = default)
        {
