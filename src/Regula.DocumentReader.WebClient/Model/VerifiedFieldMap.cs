...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    public partial class VerifiedFieldMap :  IEquatable<VerifiedFieldMap>, IValidatableObject
    {
        ...
        public VerifiedFieldMap(Integer wFieldType = default(Integer), Integer wLCID = default(Integer), string fieldMRZ = default(string), string fieldVisual = default(string), string fieldBarcode = default(string), string fieldRFID = default(string), List<Integer> matrix = default(List<Integer>))
        {
            // to ensure "wFieldType" is required (not null)
            if (wFieldType == null)
            {
                throw new InvalidDataException("wFieldType is a required property for VerifiedFieldMap and cannot be null");
            }
            else
            {
            ...
            if (wLCID == null)
            {
                throw new InvalidDataException("wLCID is a required property for VerifiedFieldMap and cannot be null");
            }
            else
            {
                this.WLCID = wLCID;
            ...
            if (matrix == null)
            {
                throw new InvalidDataException("matrix is a required property for VerifiedFieldMap and cannot be null");
            }
            else
            {
                this.Matrix = matrix;
        ...
        [DataMember(Name="Matrix", EmitDefaultValue=true)]
        public List<Integer> Matrix { get; set; }
