...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GraphicField")]
    public partial class GraphicField : IValidatableObject
    {
        ...
        public GraphicField(RectangleCoordinates fieldRect = default, GraphicFieldType fieldType = default, string fieldName = default, ImageData image = default)
        {
            ...
            if (fieldRect == null)
            {
                throw new ArgumentNullException("fieldRect is a required property for GraphicField and cannot be null");
            }
            ...
            if (fieldName == null)
            {
                throw new ArgumentNullException("fieldName is a required property for GraphicField and cannot be null");
            }
            this.FieldName = fieldName;
            // to ensure "image" is required (not null)
            if (image == null)
            {
                throw new ArgumentNullException("image is a required property for GraphicField and cannot be null");
            }
            this.Image = image;
        }
