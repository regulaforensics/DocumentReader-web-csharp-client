...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    /// PointsContainer
    /// </summary>
    [DataContract(Name = "PointsContainer")]
    public partial class PointsContainer : IValidatableObject
    {
        ...
        public PointsContainer(int pointCount = default(int), List<Point> pointsList = default(List<Point>))
        {
            ...
            if (pointsList == null)
            {
                throw new ArgumentNullException("pointsList is a required property for PointsContainer and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "PointsList", IsRequired = true, EmitDefaultValue = true)]
