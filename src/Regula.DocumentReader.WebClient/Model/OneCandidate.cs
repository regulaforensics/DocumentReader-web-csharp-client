...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    public partial class OneCandidate : IValidatableObject
    {
        ...
        [JsonConstructor]
        public OneCandidate(string documentName, int iD, decimal p, int rotated180, RfidLocation rFIDPresence, FDSIDList fDSIDList, int necessaryLights, int checkAuthenticity, int uVExp, int authenticityNecessaryLights, decimal oVIExp, Option<int?> rotationAngle = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="OneCandidate" />
    /// </summary>
    public class OneCandidateJsonConverter : JsonConverter<OneCandidate>
    {
        /// <summary>
        /// Deserializes json to <see cref="OneCandidate" />
        /// </summary>
        ...
        public override OneCandidate Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!documentName.IsSet)
                throw new ArgumentException("Property is required for class OneCandidate.", nameof(documentName));

            if (!iD.IsSet)
                throw new ArgumentException("Property is required for class OneCandidate.", nameof(iD));

            if (!p.IsSet)
                throw new ArgumentException("Property is required for class OneCandidate.", nameof(p));

            if (!rotated180.IsSet)
                throw new ArgumentException("Property is required for class OneCandidate.", nameof(rotated180));

            if (!rFIDPresence.IsSet)
                throw new ArgumentException("Property is required for class OneCandidate.", nameof(rFIDPresence));

            if (!fDSIDList.IsSet)
                throw new ArgumentException("Property is required for class OneCandidate.", nameof(fDSIDList));

            if (!necessaryLights.IsSet)
                throw new ArgumentException("Property is required for class OneCandidate.", nameof(necessaryLights));

            if (!checkAuthenticity.IsSet)
                throw new ArgumentException("Property is required for class OneCandidate.", nameof(checkAuthenticity));

            if (!uVExp.IsSet)
                throw new ArgumentException("Property is required for class OneCandidate.", nameof(uVExp));

            if (!authenticityNecessaryLights.IsSet)
                throw new ArgumentException("Property is required for class OneCandidate.", nameof(authenticityNecessaryLights));

            if (!oVIExp.IsSet)
                throw new ArgumentException("Property is required for class OneCandidate.", nameof(oVIExp));

            if (documentName.IsSet && documentName.Value == null)
                throw new ArgumentNullException(nameof(documentName), "Property is not nullable for class OneCandidate.");

            if (iD.IsSet && iD.Value == null)
                throw new ArgumentNullException(nameof(iD), "Property is not nullable for class OneCandidate.");

            if (p.IsSet && p.Value == null)
                throw new ArgumentNullException(nameof(p), "Property is not nullable for class OneCandidate.");

            if (rotated180.IsSet && rotated180.Value == null)
                throw new ArgumentNullException(nameof(rotated180), "Property is not nullable for class OneCandidate.");

            if (rFIDPresence.IsSet && rFIDPresence.Value == null)
                throw new ArgumentNullException(nameof(rFIDPresence), "Property is not nullable for class OneCandidate.");

            if (fDSIDList.IsSet && fDSIDList.Value == null)
                throw new ArgumentNullException(nameof(fDSIDList), "Property is not nullable for class OneCandidate.");

            if (necessaryLights.IsSet && necessaryLights.Value == null)
                throw new ArgumentNullException(nameof(necessaryLights), "Property is not nullable for class OneCandidate.");

            if (checkAuthenticity.IsSet && checkAuthenticity.Value == null)
                throw new ArgumentNullException(nameof(checkAuthenticity), "Property is not nullable for class OneCandidate.");

            if (uVExp.IsSet && uVExp.Value == null)
                throw new ArgumentNullException(nameof(uVExp), "Property is not nullable for class OneCandidate.");

            if (authenticityNecessaryLights.IsSet && authenticityNecessaryLights.Value == null)
                throw new ArgumentNullException(nameof(authenticityNecessaryLights), "Property is not nullable for class OneCandidate.");

            if (oVIExp.IsSet && oVIExp.Value == null)
                throw new ArgumentNullException(nameof(oVIExp), "Property is not nullable for class OneCandidate.");

            if (rotationAngle.IsSet && rotationAngle.Value == null)
                throw new ArgumentNullException(nameof(rotationAngle), "Property is not nullable for class OneCandidate.");

            return new OneCandidate(documentName.Value!, iD.Value!.Value!, p.Value!.Value!, rotated180.Value!.Value!, rFIDPresence.Value!.Value!, fDSIDList.Value!, necessaryLights.Value!.Value!, checkAuthenticity.Value!.Value!, uVExp.Value!.Value!, authenticityNecessaryLights.Value!.Value!, oVIExp.Value!.Value!, rotationAngle);
        }

        /// <summary>
        /// Serializes a <see cref="OneCandidate" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="oneCandidate"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, OneCandidate oneCandidate, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, oneCandidate, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="OneCandidate" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="oneCandidate"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, OneCandidate oneCandidate, JsonSerializerOptions jsonSerializerOptions)
        {
            if (oneCandidate.DocumentName == null)
                throw new ArgumentNullException(nameof(oneCandidate.DocumentName), "Property is required for class OneCandidate.");

            if (oneCandidate.FDSIDList == null)
                throw new ArgumentNullException(nameof(oneCandidate.FDSIDList), "Property is required for class OneCandidate.");

            writer.WriteString("DocumentName", oneCandidate.DocumentName);

            writer.WriteNumber("ID", oneCandidate.ID);

            writer.WriteNumber("P", oneCandidate.P);

            writer.WriteNumber("Rotated180", oneCandidate.Rotated180);

            var rFIDPresenceRawValue = RfidLocationValueConverter.ToJsonValue(oneCandidate.RFIDPresence);
            writer.WriteNumber("RFID_Presence", rFIDPresenceRawValue);

            writer.WritePropertyName("FDSIDList");
            JsonSerializer.Serialize(writer, oneCandidate.FDSIDList, jsonSerializerOptions);
            writer.WriteNumber("NecessaryLights", oneCandidate.NecessaryLights);

            writer.WriteNumber("CheckAuthenticity", oneCandidate.CheckAuthenticity);

            writer.WriteNumber("UVExp", oneCandidate.UVExp);

            writer.WriteNumber("AuthenticityNecessaryLights", oneCandidate.AuthenticityNecessaryLights);

            writer.WriteNumber("OVIExp", oneCandidate.OVIExp);

            if (oneCandidate.RotationAngleOption.IsSet)
                writer.WriteNumber("RotationAngle", oneCandidate.RotationAngleOption.Value!.Value);
        }
    }
}
