...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    public partial class OneCandidate :  IEquatable<OneCandidate>, IValidatableObject
    {
        ...
        public OneCandidate(string documentName = default(string), int iD = default(int), decimal p = default(decimal), bool? rotated180 = default(bool?), int rFIDPresence = default(int), FDSIDList fDSIDList = default(FDSIDList), int necessaryLights = default(int), int checkAuthenticity = default(int), int uVExp = default(int), int authenticityNecessaryLights = default(int), decimal oVIExp = default(decimal))
        {
            ...
            {
                throw new InvalidDataException("documentName is a required property for OneCandidate and cannot be null");
            }
            else
            {
            ...
            if (iD == null)
            {
                throw new InvalidDataException("iD is a required property for OneCandidate and cannot be null");
            }
            else
            {
                this.ID = iD;
            ...
            if (p == null)
            {
                throw new InvalidDataException("p is a required property for OneCandidate and cannot be null");
            }
            else
            {
                this.P = p;
            ...
            if (rotated180 == null)
            {
                throw new InvalidDataException("rotated180 is a required property for OneCandidate and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("rFIDPresence is a required property for OneCandidate and cannot be null");
            }
            else
            {
            ...
            if (fDSIDList == null)
            {
                throw new InvalidDataException("fDSIDList is a required property for OneCandidate and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("necessaryLights is a required property for OneCandidate and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("checkAuthenticity is a required property for OneCandidate and cannot be null");
            }
            else
            {
            ...
            if (uVExp == null)
            {
                throw new InvalidDataException("uVExp is a required property for OneCandidate and cannot be null");
            }
            else
            {
                this.UVExp = uVExp;
            ...
            {
                throw new InvalidDataException("authenticityNecessaryLights is a required property for OneCandidate and cannot be null");
            }
            else
            {
            ...
            if (oVIExp == null)
            {
                throw new InvalidDataException("oVIExp is a required property for OneCandidate and cannot be null");
            }
            else
            {
                this.OVIExp = oVIExp;
