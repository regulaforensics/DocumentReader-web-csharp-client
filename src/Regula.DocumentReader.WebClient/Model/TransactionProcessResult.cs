...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TransactionProcessResult :  IEquatable<TransactionProcessResult>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TransactionProcessResult);
        }

        /// <summary>
        /// Returns true if TransactionProcessResult instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionProcessResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionProcessResult input)
        {
            if (input == null)
                return false;
