...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    public partial class Status :  IEquatable<Status>, IValidatableObject
    {
        ...
        public Status(int overallStatus = default(int), int optical = default(int), int portrait = default(int), int rfid = default(int), int stopList = default(int), DetailsRFID detailsRFID = default(DetailsRFID), DetailsOptical detailsOptical = default(DetailsOptical))
        {
            ...
            if (portrait == null)
            {
                throw new InvalidDataException("portrait is a required property for Status and cannot be null");
            }
            else
            {
            ...
            // to ensure "rfid" is required (not null)
            if (rfid == null)
            {
                throw new InvalidDataException("rfid is a required property for Status and cannot be null");
            }
            else
            {
                this.Rfid = rfid;
            ...
            // to ensure "stopList" is required (not null)
            if (stopList == null)
            {
                throw new InvalidDataException("stopList is a required property for Status and cannot be null");
            }
            else
            {
