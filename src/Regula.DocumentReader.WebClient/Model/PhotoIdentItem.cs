...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    /// PhotoIdentItem
    /// </summary>
    [DataContract(Name = "PhotoIdentItem")]
    public partial class PhotoIdentItem : IValidatableObject
    {
        ...
        public PhotoIdentItem(Light lightIndex = default, RectangleCoordinates area = default, ImageData sourceImage = default, RawImageContainerList resultImages = default, int? fieldTypesCount = default, List<int> fieldTypesList = default, int? step = default, int? angle = default, int? reserved3 = default)
        {
            ...
            if (area == null)
            {
                throw new ArgumentNullException("area is a required property for PhotoIdentItem and cannot be null");
            }
            this.Area = area;
            // to ensure "sourceImage" is required (not null)
            if (sourceImage == null)
            {
                throw new ArgumentNullException("sourceImage is a required property for PhotoIdentItem and cannot be null");
            }
            this.SourceImage = sourceImage;
            // to ensure "resultImages" is required (not null)
            if (resultImages == null)
            {
                throw new ArgumentNullException("resultImages is a required property for PhotoIdentItem and cannot be null");
            }
