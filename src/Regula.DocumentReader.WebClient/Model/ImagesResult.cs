...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    /// ImagesResult
    /// </summary>
    [DataContract(Name = "ImagesResult")]
    public partial class ImagesResult : ResultItem, IValidatableObject
    {
        ...
        public ImagesResult(Images images = default, int? bufLength = default, int? light = default, int? listIdx = default, int? pageIdx = default, Result resultType = Result.IMAGES) : base(bufLength, light, listIdx, pageIdx, resultType)
        {
            // to ensure "images" is required (not null)
            if (images == null)
            {
                throw new ArgumentNullException("images is a required property for ImagesResult and cannot be null");
            }
            this.Images = images;
        }
