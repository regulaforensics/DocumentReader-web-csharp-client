...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ImagesResult :  IEquatable<ImagesResult>, IValidatableObject
    {
        /// <summary>
        ...
        public ImagesResult(Images images = default(Images), int bufLength = default(int), int light = default(int), int listIdx = default(int), int pageIdx = default(int), int resultType = 0)
        {
            ...
            if (resultType == null)
            {
                throw new InvalidDataException("resultType is a required property for ImagesResult and cannot be null");
            }
            else
            {
