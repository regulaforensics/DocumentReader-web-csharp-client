...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    public partial class OCRSecurityTextResult : AuthenticityCheckResultItem,  IEquatable<OCRSecurityTextResult>, IValidatableObject
    {
        ...
        public OCRSecurityTextResult(Critical? criticalFlag = default(Critical?), int lightType = default(int), RectangleCoordinates fieldRect = default(RectangleCoordinates), int etalonResultType = default(int), int etalonFieldType = default(int), int etalonLightType = default(int), string securityTextResultOCR = default(string), string etalonResultOCR = default(string), int reserved1 = default(int), int reserved2 = default(int), int type = "OCRSecurityTextResult", int elementResult = default(int), CheckDiagnose? elementDiagnose = default(CheckDiagnose?)) : base(type, elementResult, elementDiagnose)
        {
