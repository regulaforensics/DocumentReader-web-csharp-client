...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LexicalAnalysisResult :  IEquatable<LexicalAnalysisResult>, IValidatableObject
    {
        /// <summary>
        ...
        public LexicalAnalysisResult(ListVerifiedFields listVerifiedFields = default(ListVerifiedFields), int bufLength = default(int), int light = default(int), int listIdx = default(int), int pageIdx = default(int), int resultType = 0)
        {
            // to ensure "listVerifiedFields" is required (not null)
            if (listVerifiedFields == null)
            {
                throw new InvalidDataException("listVerifiedFields is a required property for LexicalAnalysisResult and cannot be null");
            }
            else
            {
            ...
            if (resultType == null)
            {
                throw new InvalidDataException("resultType is a required property for LexicalAnalysisResult and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        [DataMember(Name="ListVerifiedFields", EmitDefaultValue=true)]
