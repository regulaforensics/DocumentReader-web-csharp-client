...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    public partial class Healthcheck :  IEquatable<Healthcheck>, IValidatableObject
    {
        ...
        public Healthcheck(string app = default(string), string licenseId = default(string), string licenseType = default(string), string licenseSerial = default(string), DateTime? licenseValidUntil = default(DateTime?), List<string> scenarios = default(List<string>), string version = default(string), HealthcheckDocumentsDatabase documentsDatabase = default(HealthcheckDocumentsDatabase))
        {
