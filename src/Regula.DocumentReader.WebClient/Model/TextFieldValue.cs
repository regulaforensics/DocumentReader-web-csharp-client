...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    public partial class TextFieldValue :  IEquatable<TextFieldValue>, IValidatableObject
    {
        ...
        public TextFieldValue(String source = default(String), string value = default(string), string originalValue = default(string), Integer originalValidity = default(Integer), List<OriginalSymbol> originalSymbols = default(List<OriginalSymbol>), int pageIndex = default(int), int probability = default(int), RectangleCoordinates fieldRect = default(RectangleCoordinates), RfidOrigin rfidOrigin = default(RfidOrigin))
        {
            ...
            // to ensure "originalValidity" is required (not null)
            if (originalValidity == null)
            {
                throw new InvalidDataException("originalValidity is a required property for TextFieldValue and cannot be null");
            }
            else
            {
            ...
            if (probability == null)
            {
                throw new InvalidDataException("probability is a required property for TextFieldValue and cannot be null");
            }
            else
            {
        ...
        public bool Equals(TextFieldValue input)
        {
            ...
            return 
                ...
                (
                    this.OriginalValidity == input.OriginalValidity ||
                    (this.OriginalValidity != null &&
                    this.OriginalValidity.Equals(input.OriginalValidity))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.OriginalValidity != null)
                    hashCode = hashCode * 59 + this.OriginalValidity.GetHashCode();
