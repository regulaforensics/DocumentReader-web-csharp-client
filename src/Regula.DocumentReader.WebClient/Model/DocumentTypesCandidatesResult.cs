...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DocumentTypesCandidatesResult :  IEquatable<DocumentTypesCandidatesResult>, IValidatableObject
    {
        /// <summary>
        ...
        public DocumentTypesCandidatesResult(DocumentTypesCandidatesList candidatesList = default(DocumentTypesCandidatesList), int bufLength = default(int), int light = default(int), int listIdx = default(int), int pageIdx = default(int), int resultType = 0)
        {
            // to ensure "resultType" is required (not null)
            if (resultType == null)
            {
                throw new InvalidDataException("resultType is a required property for DocumentTypesCandidatesResult and cannot be null");
            }
            else
            {
