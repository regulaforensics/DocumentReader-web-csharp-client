...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    public partial class RawImageContainerList :  IEquatable<RawImageContainerList>, IValidatableObject
    {
        ...
        protected RawImageContainerList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RawImageContainerList" /> class.
        /// </summary>
        ...
        public RawImageContainerList(int count = default(int), List<ImageData> images = default(List<ImageData>))
        {
            ...
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for RawImageContainerList and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            if (images == null)
            {
                throw new InvalidDataException("images is a required property for RawImageContainerList and cannot be null");
            }
            else
            {
                this.Images = images;
