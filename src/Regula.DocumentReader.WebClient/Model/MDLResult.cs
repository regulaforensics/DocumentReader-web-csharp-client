...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    public partial class MDLResult : ResultItem, IValidatableObject
    {
        ...
        public MDLResult(Dictionary<string, Object> mDLParsedResponse = default, int? bufLength = default, int? light = default, int? listIdx = default, int? pageIdx = default, Result resultType = Result.MDL_PARSED_RESPONSE) : base(bufLength, light, listIdx, pageIdx, resultType)
        {
