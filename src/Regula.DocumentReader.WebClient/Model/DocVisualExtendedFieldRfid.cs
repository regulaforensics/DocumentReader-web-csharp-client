...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    public partial class DocVisualExtendedFieldRfid :  IEquatable<DocVisualExtendedFieldRfid>, IValidatableObject
    {
        ...
        protected DocVisualExtendedFieldRfid() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DocVisualExtendedFieldRfid" /> class.
        /// </summary>
        /// <param name="rFIDOriginDG">rFIDOriginDG (required).</param>
        /// <param name="rFIDOriginDGTag">rFIDOriginDGTag.</param>
        /// <param name="rFIDOriginTagEntry">Record index of the text field source in the data group (required).</param>
        ...
        public DocVisualExtendedFieldRfid(Integer rFIDOriginDG = default(Integer), Object rFIDOriginDGTag = default(Object), decimal rFIDOriginTagEntry = default(decimal), Object rFIDOriginEntryView = default(Object), Object fieldType = default(Object), Integer wFieldType = default(Integer), string fieldName = default(string), decimal stringsCount = default(decimal), List<StringRecognitionResult> stringsResult = default(List<StringRecognitionResult>), decimal bufLength = default(decimal), string bufText = default(string), Object fieldMask = default(Object), Object validity = default(Object), Object inComparison = default(Object), Object reserved2 = default(Object), Object reserved3 = default(Object))
        {
            ...
            {
                throw new InvalidDataException("rFIDOriginDG is a required property for DocVisualExtendedFieldRfid and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("rFIDOriginTagEntry is a required property for DocVisualExtendedFieldRfid and cannot be null");
            }
            else
            {
            ...
            if (fieldType == null)
            {
                throw new InvalidDataException("fieldType is a required property for DocVisualExtendedFieldRfid and cannot be null");
            }
            else
            {
            ...
            if (wFieldType == null)
            {
                throw new InvalidDataException("wFieldType is a required property for DocVisualExtendedFieldRfid and cannot be null");
            }
            else
            {
            ...
            if (fieldName == null)
            {
                throw new InvalidDataException("fieldName is a required property for DocVisualExtendedFieldRfid and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("stringsCount is a required property for DocVisualExtendedFieldRfid and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("stringsResult is a required property for DocVisualExtendedFieldRfid and cannot be null");
            }
            else
            {
            ...
            if (bufLength == null)
            {
                throw new InvalidDataException("bufLength is a required property for DocVisualExtendedFieldRfid and cannot be null");
            }
            else
            {
            ...
            if (bufText == null)
            {
                throw new InvalidDataException("bufText is a required property for DocVisualExtendedFieldRfid and cannot be null");
            }
            else
            {
        ...
        public Object RFIDOriginDGTag { get; set; }
        ...
        {
            return this.Equals(input as DocVisualExtendedFieldRfid);
        }

        /// <summary>
        /// Returns true if DocVisualExtendedFieldRfid instances are equal
        /// </summary>
        /// <param name="input">Instance of DocVisualExtendedFieldRfid to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocVisualExtendedFieldRfid input)
        {
            if (input == null)
                return false;
