...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SymbolCandidate")]
    public partial class SymbolCandidate : IValidatableObject
    {
        ...
        public SymbolCandidate(long symbolCode = default, int symbolProbability = default, int? varClass = default, int? subClass = default)
        {
        ...
        [DataMember(Name = "SymbolProbability", IsRequired = true, EmitDefaultValue = true)]
