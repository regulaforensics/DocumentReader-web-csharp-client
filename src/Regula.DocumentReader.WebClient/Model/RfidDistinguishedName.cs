...
namespace Regula.DocumentReader.WebClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RfidDistinguishedName")]
    public partial class RfidDistinguishedName : IValidatableObject
    {
        ...
        public RfidDistinguishedName(string data = default(string), TrfFtString friendlyName = default(TrfFtString), List<RfidAttributeName> attributes = default(List<RfidAttributeName>))
        {
            ...
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for RfidDistinguishedName and cannot be null");
            }
            this.Data = data;
            // to ensure "friendlyName" is required (not null)
            if (friendlyName == null)
            {
                throw new ArgumentNullException("friendlyName is a required property for RfidDistinguishedName and cannot be null");
            }
            this.FriendlyName = friendlyName;
            // to ensure "attributes" is required (not null)
            if (attributes == null)
            {
                throw new ArgumentNullException("attributes is a required property for RfidDistinguishedName and cannot be null");
            }
